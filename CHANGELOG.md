...
- `build-full-installer-1.patch` and `build-full-installer-2.patch` were identical. Delete `build-full-installer-2.patch` and renumber the remaining `build-full-installer` patch files.
